  ...
  return (
    <>
      ...
      <div className="bg-white flex flex-col md:flex-row justify-center md:gap-28 items-center my-28 md:my-72">
        <div className="flex flex-col max-w-md md:max-w-lg text-center">
        ...
        <div className="px-10 pt-10 max-w-lg items-center text-sm">
          {faqList.map((faq) => (
            <div
              key={faq.question}
              className="relative w-full overflow-hidden border-b-2 border-grey-500 py-2"
            >
              <input
                type="checkbox"
                className="absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer peer jus"
              />
              <div className=" h-12 w-10/12  flex items-center">
